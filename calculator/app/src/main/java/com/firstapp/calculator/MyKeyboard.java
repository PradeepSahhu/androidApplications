...
public class MyKeyboard extends LinearLayout implements View.OnClickListener {
    ...
    private Button mButtonmulitply;
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        mButtonmulitply = (Button) findViewById(R.id.button_multiply);
        mButtonDivide = (Button) findViewById(R.id.button_divide);
        mButtonModulo = (Button) findViewById(R.id.button_modulo);
        ...
        mButtonmulitply.setOnClickListener(this);
        ...
        keyValues.put(R.id.button_multiply, "x");
        keyValues.put(R.id.button_divide, "/");
        keyValues.put(R.id.button_modulo, "%");
